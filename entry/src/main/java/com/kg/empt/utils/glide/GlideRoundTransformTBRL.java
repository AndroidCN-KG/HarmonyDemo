 ...
 * 说明： glide 输出指定圆角 <br>
 * 作者：陈晓凯<br>
 * 时间：2020-7-13 10:56<br>
 * 修改记录： <br>
 */
public class GlideRoundTransformTBRL extends BitmapTransformation {

    private static final int VERSION = 1;
    private static final String ID = "jp.wasabeef.glide.transformations.GlideRoundTransformTBRL." + VERSION;
    ...
    public GlideRoundTransformTBRL(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public GlideRoundTransformTBRL(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
...
//        canvas.drawPixelMapHolderRoundRectShape(new );
    ...
    public boolean equals(Object o) {
        return o instanceof GlideRoundTransformTBRL &&
                ((GlideRoundTransformTBRL) o).radius == radius &&
                ((GlideRoundTransformTBRL) o).diameter == diameter &&
                ((GlideRoundTransformTBRL) o).margin == margin &&
                ((GlideRoundTransformTBRL) o).cornerType == cornerType;
    }
